...
<body>
  ...
  <script nonce="<?php echo e(csp_nonce()); ?>">(function(){var c=document.getElementById('remember-me'),w=document.getElementById('remember-warning');if(c&&w)c.addEventListener('change',function(){w.classList.toggle('show',c.checked);});})();</script>
</body>
</html>
