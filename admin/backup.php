...
$svc=hope_backup_service(); $msg=(string)($_SESSION['backup_flash']??''); $err=(string)($_SESSION['backup_flash_error']??''); unset($_SESSION['backup_flash'],$_SESSION['backup_flash_error']);
