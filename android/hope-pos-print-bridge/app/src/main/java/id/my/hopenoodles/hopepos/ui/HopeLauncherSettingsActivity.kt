...
class HopeLauncherSettingsActivity : AppCompatActivity() {
    ...
    private fun buildUi() {
        ...
        content.addView(bigButton("Buka Printer Settings HOPe") { startActivity(Intent(this, PrinterSettingsActivity::class.java)) })
    ...
    private fun statusText(): TextView {
        val home = if (kioskManager.isHopeDefaultHome()) "HOPe sudah menjadi Home default" else "HOPe belum menjadi Home default"
    ...
    private fun refreshBackgroundStatus() {
        ...
        backgroundStatus.text = if (prefs.getLauncherBackgroundUri().isNullOrBlank()) {
            "Background aktif: default merah HOPe."
        } else {
    ...
    private fun refreshAppGrids() {
        ...
        if (activeApps.isEmpty()) {
            activeAppsGrid.addView(emptyText("Belum ada aplikasi tambahan. HOPe POS tetap tampil sebagai ikon utama."))
        } else {
    ...
    private fun confirmAdd(app: AppChoice) {
        ...
        if (app.packageName == packageName) {
            Toast.makeText(this, "HOPe POS sudah tersedia sebagai ikon utama.", Toast.LENGTH_LONG).show()
            return
        }
        AlertDialog.Builder(this)
            .setTitle("Tambah aplikasi")
            .setMessage("Tambahkan ${app.label} ke launcher HOPe?")
    ...
    private fun confirmRemove(app: AppChoice) {
        AlertDialog.Builder(this)
            ...
            .setMessage("Keluarkan ${app.label} dari launcher HOPe?\n\nAplikasi tidak akan di-uninstall dari tablet.")
    ...
    private fun confirmResetSetup() {
        AlertDialog.Builder(this)
            ...
            .setMessage("Setup HOPe Launcher akan dihapus. Setelah itu aplikasi meminta setup awal lagi.")
    ...
    private fun appTile(app: AppChoice, actionLabel: String, action: () -> Unit): LinearLayout {
        return LinearLayout(this).apply {
            ...
            addView(ImageView(this@HopeLauncherSettingsActivity).apply {
            ...
            addView(TextView(this@HopeLauncherSettingsActivity).apply {
                text = app.label
                textSize = 13f
                gravity = Gravity.CENTER
                maxLines = 2
