...
class MainActivity : AppCompatActivity() {
    ...
    private fun showExitPinDialog() {
        ...
        AlertDialog.Builder(this)
            ...
            .setMessage("Masukkan PIN untuk membuka mode kiosk Hope.")
            .setView(input)
    ...
    private fun showAdminPinDialog() {
        ...
        AlertDialog.Builder(this)
            .setTitle("Admin Hope")
            .setMessage("Masukkan PIN untuk keluar sementara dari Hope dan membuka launcher Infinix/Android.")
            .setView(input)
            .setPositiveButton("Buka") { dialog, _ ->
                val pin = input.text?.toString().orEmpty()
                if (kioskPrefs.verifyPin(pin)) {
    ...
    private fun showAdminPanelDialog() {
        ...
        val home = if (kioskManager.isHopeDefaultHome()) "Hope" else "bukan Hope"
    ...
    companion object {
        ...
        private const val STATE_CURRENT_URL = "hope_current_url"
